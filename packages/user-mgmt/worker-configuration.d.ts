/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2377f9d1f1ecc9dbd57c1e5879232ffc)
// Runtime types generated with workerd@1.20250617.0 2024-01-17 
declare namespace Cloudflare {
	interface Env {
		EMAIL_FROM: "noreply@justblackmagic.com";
		EMAIL_FROM_NAME: "Black Magic Consulting";
		EMAIL_DKIM_SELECTOR: "mailchannels";
		EMAIL_DKIM_DOMAIN: "justblackmagic.com";
		FORGOT_PASSWORD_URL: "https://account-pages.tools.justblackmagic.com/forgot-password-reset.html";
		TOKEN_VALID_MINUTES: 60;
		RBAC_ENABLED: "false";
		SUPER_ADMIN_EMAIL: "";
		usersDB: D1Database;
		sessionService: Fetcher /* session-state */;
	}
}
